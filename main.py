...
async def print_message(client, message):
...
async def help(client, message):
    ...
    • `!face`: Sends a random generated face.
    • `!faceai`: Sends a random generated face with a brief biography generated by GPT-3.
